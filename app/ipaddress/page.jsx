...
import image1 from "../../public/assets/project/project1.JPG";
        ...
        <div className="col-span-4 space-y-5">
          ...
          <div>
            <a
              ...
              target="_blank"
              className="px-8 py-2 mt-4 mr-8 bg-blue-500 rounded-lg"
            >
              DEMO
            </a>
            <a
              ...
              target="_blank"
              className="px-8 py-2 mt-4 bg-blue-500 rounded-lg"
            >
              CODE
            </a>
          </div>
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              ...
              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill className="pr-1" /> geolocation
              </p>
              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill className="pr-1" /> leafly Map
              </p>
            </div>
          </div>
        </div>
