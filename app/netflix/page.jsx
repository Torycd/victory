...
import image1 from "../../public/assets/project/project0.JPG";
        ...
        <div className="col-span-4 space-y-5">
          ...
          <div>
            <a
              ...
              target="_blank"
              className="px-8 py-2 mt-4 mr-8 bg-red-500 rounded-lg"
            >
              DEMO
            </a>
            <a
              ...
              target="_blank"
              className="px-8 py-2 mt-4 bg-red-500 rounded-lg"
            >
              CODE
            </a>
          </div>
